...
import work.dirtsai.mockredbook.count.biz.domain.mapper.NoteCountDOMapper;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "mockbook_group_" + MQConstants.TOPIC_COUNT_NOTE_LIKE_2_DB, // Group 组
