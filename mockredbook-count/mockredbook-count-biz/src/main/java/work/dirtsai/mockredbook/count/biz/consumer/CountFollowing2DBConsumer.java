...
import work.dirtsai.mockredbook.count.biz.domain.mapper.UserCountDOMapper;
import work.dirtsai.mockredbook.count.biz.enums.FollowUnfollowTypeEnum;
import work.dirtsai.mockredbook.count.biz.model.dto.CountFollowUnfollowMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "mockbook_group_" + MQConstants.TOPIC_COUNT_FOLLOWING_2_DB, // Group 组
