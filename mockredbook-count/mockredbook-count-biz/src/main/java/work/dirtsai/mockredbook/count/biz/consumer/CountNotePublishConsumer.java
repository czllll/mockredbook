...
import work.dirtsai.mockredbook.count.biz.model.dto.NoteOperateMqDTO;

import java.util.Objects;

@Component
@RocketMQMessageListener(consumerGroup = "mockbook_group_" + MQConstants.TOPIC_NOTE_OPERATE, // Group 组
