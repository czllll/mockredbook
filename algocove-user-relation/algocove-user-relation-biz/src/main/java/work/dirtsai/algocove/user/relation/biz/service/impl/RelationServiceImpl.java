package work.dirtsai.algocove.user.relation.biz.service.impl;
...
import work.dirtsai.algocove.user.relation.biz.constant.MQConstants;
import work.dirtsai.algocove.user.relation.biz.constant.RedisKeyConstants;
import work.dirtsai.algocove.user.relation.biz.domain.dataobject.FansDO;
import work.dirtsai.algocove.user.relation.biz.domain.dataobject.FollowingDO;
import work.dirtsai.algocove.user.relation.biz.domain.mapper.FansDOMapper;
import work.dirtsai.algocove.user.relation.biz.domain.mapper.FollowingDOMapper;
import work.dirtsai.algocove.user.relation.biz.enums.LuaResultEnum;
import work.dirtsai.algocove.user.relation.biz.enums.ResponseCodeEnum;
import work.dirtsai.algocove.user.relation.biz.model.dto.FollowUserMqDTO;
import work.dirtsai.algocove.user.relation.biz.model.dto.UnfollowUserMqDTO;
import work.dirtsai.algocove.user.relation.biz.model.vo.*;
import work.dirtsai.algocove.user.relation.biz.rpc.UserRpcService;
...
public class RelationServiceImpl implements RelationService {
    ...
    public Response<?> follow(FollowUserReqVO followUserReqVO) {
        ...
        // 校验关注的用户是否存在
        FindUserByIdRespDTO findUserByIdRspDTO = userRpcService.findById(followUserId);
    ...
    public Response<?> unfollow(UnfollowUserReqVO unfollowUserReqVO) {
        ...
        // 校验关注的用户是否存在
        FindUserByIdRespDTO findUserByIdRspDTO = userRpcService.findById(unfollowUserId);
