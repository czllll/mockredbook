package work.dirtsai.algocove.user.biz.service.impl;
...
import work.dirtsai.algocove.oss.api.FileFeignApi;
import work.dirtsai.algocove.user.biz.constant.RedisKeyConstants;
import work.dirtsai.algocove.user.biz.constant.RoleConstants;
import work.dirtsai.algocove.user.biz.domain.dataobject.RoleDO;
import work.dirtsai.algocove.user.biz.domain.dataobject.UserCountDO;
import work.dirtsai.algocove.user.biz.domain.dataobject.UserDO;
import work.dirtsai.algocove.user.biz.domain.dataobject.UserRoleDO;
import work.dirtsai.algocove.user.biz.domain.mapper.RoleDOMapper;
import work.dirtsai.algocove.user.biz.domain.mapper.UserCountDOMapper;
import work.dirtsai.algocove.user.biz.domain.mapper.UserDOMapper;
import work.dirtsai.algocove.user.biz.domain.mapper.UserRoleDOMapper;
import work.dirtsai.algocove.user.biz.enums.ResponseCodeEnum;
import work.dirtsai.algocove.user.biz.enums.SexEnum;
import work.dirtsai.algocove.user.biz.model.vo.FindUserProfileReqVO;
import work.dirtsai.algocove.user.biz.model.vo.FindUserProfileRspVO;
import work.dirtsai.algocove.user.biz.model.vo.UpdateUserInfoReqVO;
import work.dirtsai.algocove.user.biz.rpc.CountRpcService;
import work.dirtsai.algocove.user.biz.rpc.DistributedIdGeneratorRpcService;
import work.dirtsai.algocove.user.biz.rpc.OssRpcService;
import work.dirtsai.algocove.user.biz.service.UserService;
import work.dirtsai.algocove.user.dto.req.*;
...
import work.dirtsai.algocove.user.dto.resp.FindUserByPhoneRspDTO;
...
public class UserServiceImpl implements UserService {
    ...
    public Response<FindUserByIdRespDTO> findById(FindUserByIdReqDTO findUserByIdReqDTO) {
        ...
        if (StringUtils.isNotBlank(userInfoRedisValue)) {
            ...
            FindUserByIdRespDTO findUserByIdRspDTO = JsonUtils.parseObject(userInfoRedisValue, FindUserByIdRespDTO.class);
            // 异步线程中将用户信息存入本地缓存
