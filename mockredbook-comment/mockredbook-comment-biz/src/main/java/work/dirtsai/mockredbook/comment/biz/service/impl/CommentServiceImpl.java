package work.dirtsai.mockredbook.comment.biz.service.impl;
...
import work.dirtsai.mockredbook.comment.biz.constant.MQConstants;
import work.dirtsai.mockredbook.comment.biz.constant.RedisKeyConstants;
import work.dirtsai.mockredbook.comment.biz.domain.dataobject.CommentDO;
import work.dirtsai.mockredbook.comment.biz.domain.dataobject.CommentLikeDO;
import work.dirtsai.mockredbook.comment.biz.domain.mapper.CommentDOMapper;
import work.dirtsai.mockredbook.comment.biz.domain.mapper.CommentLikeDOMapper;
import work.dirtsai.mockredbook.comment.biz.domain.mapper.NoteCountDOMapper;
import work.dirtsai.mockredbook.comment.biz.enums.*;
import work.dirtsai.mockredbook.comment.biz.model.dto.LikeUnlikeCommentMqDTO;
import work.dirtsai.mockredbook.comment.biz.model.dto.PublishCommentMqDTO;
import work.dirtsai.mockredbook.comment.biz.model.vo.*;
import work.dirtsai.mockredbook.comment.biz.retry.SendMqRetryHelper;
import work.dirtsai.mockredbook.comment.biz.rpc.DistributedIdGeneratorRpcService;
import work.dirtsai.mockredbook.comment.biz.rpc.KeyValueRpcService;
import work.dirtsai.mockredbook.comment.biz.rpc.UserRpcService;
import work.dirtsai.mockredbook.comment.biz.service.CommentService;
import work.dirtsai.mockredbook.kv.dto.req.FindCommentContentReqDTO;
...
public class CommentServiceImpl implements CommentService {
    ...
    private void getChildCommentDataAndSync2Redis(List<CommentDO> childCommentDOS, List<FindChildCommentItemRspVO> childCommentRspVOS) {
        ...
        for (CommentDO childCommentDO : childCommentDOS) {
            ...
            // 若当前评论的 replyCommentId 不等于 parentId，则前端需要展示回复的哪个用户，如  “回复 czl：”
