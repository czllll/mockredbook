package work.dirtsai.algocove.comment.biz.consumer;
...
import work.dirtsai.algocove.comment.biz.enums.CommentLevelEnum;
import work.dirtsai.algocove.comment.biz.model.dto.CountPublishCommentMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "mockbook_group_first_reply_comment_id" + MQConstants.TOPIC_COUNT_NOTE_COMMENT, // Group 组
