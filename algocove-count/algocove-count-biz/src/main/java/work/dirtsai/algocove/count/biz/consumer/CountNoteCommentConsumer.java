...
import work.dirtsai.algocove.count.biz.model.dto.CountPublishCommentMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "mockbook_group_" + MQConstants.TOPIC_COUNT_NOTE_COMMENT, // Group 组
