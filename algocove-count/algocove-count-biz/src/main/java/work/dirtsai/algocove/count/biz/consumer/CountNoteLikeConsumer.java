...
import work.dirtsai.algocove.count.biz.constant.RedisKeyConstants;
import work.dirtsai.algocove.count.biz.enums.LikeUnlikeNoteTypeEnum;
import work.dirtsai.algocove.count.biz.model.dto.AggregationCountLikeUnlikeNoteMqDTO;
import work.dirtsai.algocove.count.biz.model.dto.CountLikeUnlikeNoteMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "mockbook_group_" + MQConstants.TOPIC_COUNT_NOTE_LIKE, // Group 组
