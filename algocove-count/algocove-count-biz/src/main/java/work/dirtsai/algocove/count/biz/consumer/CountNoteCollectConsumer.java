...
import work.dirtsai.algocove.count.biz.enums.CollectUnCollectNoteTypeEnum;
import work.dirtsai.algocove.count.biz.model.dto.CountCollectUnCollectNoteMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "mockbook_group_" + MQConstants.TOPIC_COUNT_NOTE_COLLECT, // Group 组
