...
import work.dirtsai.algocove.note.biz.domain.dataobject.NoteLikeDO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "mockbook_group_" + MQConstants.TOPIC_LIKE_OR_UNLIKE, // Group 组
