package work.dirtsai.algocove.note.biz.consumer;
...
import work.dirtsai.algocove.note.biz.domain.dataobject.NoteCollectionDO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "mockbook_group_" + MQConstants.TOPIC_COLLECT_OR_UN_COLLECT, // Group 组
